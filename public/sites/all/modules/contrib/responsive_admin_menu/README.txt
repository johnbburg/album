...
menu using hook_responsive_admin_menu_output_alter().

For a full description of the module, visit the project page:
  http://drupal.org/project/responsive_admin_menu

To submit bug reports and feature suggestions, or to track changes:
  http://drupal.org/project/issues/responsive_admin_menu
...
* To override the default administration menu icon, you may:
  ...
  2) Alter the image by overriding the theme function:
     ...
     Copy the entire theme_responsive_admin_menu_icon() function into your template.php,
     rename it to phptemplate_responsive_admin_menu_icon() or THEMENAME_responsive_admin_menu_icon(),
...
A: No. As the name implies, administration menu module is for administrative
   ...
   responsive_admin_menu.css into your theme's stylesheet and replace #admin-menu with any
...
Q: I enabled "Aggregate and compress CSS files", but responsive_admin_menu.css is still
...
A: You can suppress it by simply calling the following function in PHP:
     ...
     module_invoke('responsive_admin_menu', 'suppress');
