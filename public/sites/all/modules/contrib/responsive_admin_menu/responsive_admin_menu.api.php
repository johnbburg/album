 ...
 *
 * @see responsive_admin_menu.map.inc
 */
function hook_responsive_admin_menu_map() {
 ...
 *   Passed by reference.
 *
 * @see hook_responsive_admin_menu_output_alter()
 * @see responsive_admin_menu_links_menu()
 * @see responsive_admin_menu_links_icon()
 * @see responsive_admin_menu_links_user()
 * @see theme_responsive_admin_menu_links()
 */
function hook_responsive_admin_menu_output_build(&$content) {
}
 ...
 *   Passed by reference.
 *
 * @see hook_responsive_admin_menu_output_build()
 * @see responsive_admin_menu_links_menu()
 * @see responsive_admin_menu_links_icon()
 * @see responsive_admin_menu_links_user()
 * @see theme_responsive_admin_menu_links()
 */
function hook_responsive_admin_menu_output_alter(&$content) {
 ...
 */
function hook_responsive_admin_menu_cache_info() {
  $caches['update'] = array(
    'title' => t('Update data'),
